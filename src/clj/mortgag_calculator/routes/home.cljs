(ns mortgag-calculator.cljs.home0
    (:require
...
(defn calculate! [{:keys [params]}]
  ...
  (set! (.innerHTML (.getElementById js/document "purchase_price")(:purchase_price params)))
  (set! (.innerHTML (.getElementById js/document "deposit_paid")(:deposit_paid params)))
  (set! (.innerHTML (.getElementById js/document "bond_term")(:bond_term params)))
  (set! (.innerHTML (.getElementById js/document "fixed_interest_rate")(:fixed_interest_rate params)))
  (set! (.innerHTML (.getElementById js/document "monthly_payment")monthly_payment))
